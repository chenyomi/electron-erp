...
export const stockInAPI = {
  ...
  materialCatalog: (supplierName?: string) => api.invoke('stockIn:material-catalog', supplierName || ''),
...
export const supplierAPI = {
  ...
  materialCatalog: (supplierName: string) => api.invoke('supplier:material-catalog', supplierName),
